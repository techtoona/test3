...
# GLOBAL CONSTANT - Update to your specific paths
CHROME_PATH_LOCAL_STATE = os.path.normpath(r"H:\Doxing\Tools\decrypt-chrome-passwords-main\Local State")
CHROME_PATH_LOGIN_DATA = os.path.normpath(r"H:\Doxing\Tools\decrypt-chrome-passwords-main\Login Data")
